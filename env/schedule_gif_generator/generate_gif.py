# -*- coding: utf-8 -*-
"""
Created on Fri Sep  3 19:06:14 2021

@author: baltundas3

OpenAI Scheduling Environment Rendering into Gif File

Derived from: https://github.com/prosysscience/JSSEnv.git
"""
import gym
import unittest
import imageio
...
class TestRendering(unittest.TestCase):
    ...
    def test_optimum_ta01_gif(self):
        ...
        imageio.mimsave("ta02.gif", images)
        env.reset()
        self.assertEqual(env.current_time_step, 0)
